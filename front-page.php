...
<main class="l-main">
  ...
  <section class="p-home-about">
    <div class="p-home-about__inner l-inner">
      <div class="p-home-about__wrapper">
        <div class="p-home-about__top l-two-columns">
          <div class="p-home-about__top-item l-two-columns__item">
            <div class="p-home-about__top-left l-two-columns__left">
            ...
            <div class="p-home-about__top-right l-two-columns__right">
              <picture class="p-home-about__top-image">
        ...
        <div class="p-home-about__content l-two-columns">
          <div class="p-home-about__content-item l-two-columns__item">
            <picture class="p-home-about__content-image l-two-columns__left">
            ...
            <div class="p-home-about__content-body l-two-columns__right">
              <p class="p-home-about__content-body-text m-base-text">
              ...
              <div class="p-home-about__content-body-button">
                <a href="<?php echo home_url('/about'); ?>" class="m-button">詳しく見る</a>
              </div>
            </div>
          </div>
        </div>
        <div class="p-home-about__button-unit m-square-button-unit">
  ...
  <!-- 研修サービス -->
  <section class="p-home-training-service">
    <div class="p-home-training-service__inner l-inner">
      <picture class="p-home-training-service__bg-icon">
      ...
      <div class="p-home-training-service__header">
        ...
        <p class="p-home-training-service__header-text m-base-text">
      ...
      <div class="p-home-training-service__wrapper">
        ...
        <div class="p-home-training-service__cards l-grid">
          <?php
  ...
  <!-- 覆面調査 -->
  <section class="p-home-mystery-shopper">
    <div class="p-home-mystery-shopper__inner l-inner">
      <div class="p-home-mystery-shopper__wrapper">
        <div class="p-home-mystery-shopper__content l-two-columns">
          <div class="p-home-mystery-shopper__content-item l-two-columns__item">
            <picture class="p-home-mystery-shopper__content-image l-two-columns__left">
            ...
            <div class="p-home-mystery-shopper__content-body l-two-columns__right">
              <hgroup class="m-section-header">
              ...
              <p class="p-home-mystery-shopper__content-body-text m-base-text">
                売上に直結するCX視点の覆面調査で顧客ロイヤルティやリアル店舗の価値向上など、店舗の商売力を総合的に強化致します！
              </p>
              <div class="p-home-mystery-shopper__content-body-button">
